...
export class Api implements ApiInterface {
  ...
  private userAuthorityStatuses$ = new BehaviorSubject<UserAuthorityStatus[]>([
    { uuid: 'USER_ADMINISTRATOR_UUID', password: '7f15fa00-23ef-5e5c-9365-50de9d7e1ca5', online: false },
    { uuid: 'USER_USER_UUID', password: '7f15fa00-23ef-5e5c-9365-50de9d7e1ca5', online: false },
